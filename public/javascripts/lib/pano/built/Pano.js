	    ...
	    PanoAJK.Main.Core = function (args) {
	        ...
	        if (args.resizable) {
	            $(window).resize(function () {
	                _this.sys.canvasObject.resize(_this);
	            });
	        }
	        _this.objsToDraw = {};
	...
	(function ($) {
	    ...
	    PanoAJK.Main.WebGLContext.prototype = {
	        ...
	        cube: function (sideLength) {
	            ...
	            var indices = [];
	            var faceCorners = [[-s, -s, s, s, -s, s, s, s, s, -s, s, s], [-s, -s, -s, -s, s, -s, s, s, -s, s, -s, -s], [-s, s, -s, -s, s, s, s, s, s, s, s, -s], [-s, -s, -s, s, -s, -s, s, -s, s, -s, -s, s], [s, -s, -s, s, s, -s, s, s, s, s, -s, s], [-s, -s, -s, -s, -s, s, -s, s, s, -s, s, -s]];
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    //着色器变量
	    var aCoords, uModelview, uProjection;
	    ...
	    PanoAJK.Main.Skybox.prototype = {
	        ...
	        updateTexture: function (currentPath, applyBool) {
	            if ($.inArray(currentPath, GI.sys.imageLoadedList) != -1) {
	                ...
	                currentPath + "_right.jpg", currentPath + "_left.jpg", currentPath + "_top.jpg", currentPath + "_bottom.jpg", currentPath + "_front.jpg", currentPath + "_back.jpg"];
	                var ct = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    var aNeighCoordsLoc, uNeighViewMatLoc, uNeighProjectionLoc, uNeighAlphaLoc, aIdCurLoc, uIdSelLoc;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    var heightWidthRatio, canvasBodyWidthRatio;

	    PanoAJK.Main.Canvas = function (cavDom, hwRadio) {
	        //传入canvas的Dom元素
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    PanoAJK.Main.Controller.prototype = {
	        ...
	        bindEvent: function () {
	            $(canvas).on('mousedown', _this.mousedown).on('mousemove', _this.mousemove).on('touchstart', _this.touchstart).on('NeighPts.tap', _this.touchtap);
	        ...
	        offEvent: function () {
	            $(canvas).off('mousedown', _this.mousedown).off('mousemove', _this.mousemove).off('touchstart', _this.touchstart).off('NeighPts.tap', _this.touchtap);
	        },
	        ...
	        getCoordOnBallForPano: function (pagex, pagey) {
	            ...
	            var coordOnBall = new PanoAJK.Math.Vector3([(pagex - cavsBound.left - 0.5 * canvas.width) / GI.sys.canvasObject.halfDiagonal, (pagey - cavsBound.top - 0.5 * canvas.height) / GI.sys.canvasObject.halfDiagonal, 0]);
